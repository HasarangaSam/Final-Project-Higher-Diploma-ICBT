...
if (isset($_GET['id'])) {
    ...
    if (!$customer) {
        echo "<script>alert('Customer not found.'); window.location.href='staff_manage_customers.php';</script>";
        exit();
    }
} else {
...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if ($stmt->execute()) {
        echo "<script>alert('Customer updated successfully!'); window.location.href='staff_manage_customers.php';</script>";
    } else {
