...
if (isset($_GET['quotation_id'])) {
    ...
    $stmt_customer = $pdo->prepare("SELECT first_name, last_name FROM customer WHERE customer_id = :customer_id");
    $stmt_customer->bindParam(':customer_id', $quotation['customer_id'], PDO::PARAM_INT);
    ...
    echo "<script>alert('Quotation ID not provided.'); window.location.href='staff_build_my_pc_quotations.php';</script>";
    exit();
}
    ...
    <div class="main-content">
        <div class="container mt-5">
            ...
            <div class="card mb-4">
                ...
                <div class="card-body">
                    <p><strong>Customer Name:</strong> <?php echo htmlspecialchars($customer['first_name']) . ' ' . htmlspecialchars($customer['last_name']); ?></p>
            ...
            <a href="staff_build_my_pc_quotations.php" class="btn btn-secondary">Back to Quotations</a>
        </div>
    </div>
</div>
