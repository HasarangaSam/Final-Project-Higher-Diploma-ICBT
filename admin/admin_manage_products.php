                ...
                <tbody>
                    ...
                    while ($row = $stmt->fetch(PDO::FETCH_ASSOC)) {
                        ...
                        if (filter_var($row['image_url'], FILTER_VALIDATE_URL)) {
                            ...
                            // If it's a relative path, adjust the path to be relative to the web root
                            $image = $row['image_url'];
                        }
                        ...
                        echo "<td>
                                ...
                                <a href='delete_product.php?id={$row['product_id']}' class='btn btn-danger btn-sm' onclick='return confirm(\"Are you sure you want to delete this product?\")'><i class='bi bi-trash'></i> Delete</a>
                              </td>";
                        echo "</tr>";
                    }
                    ?>
